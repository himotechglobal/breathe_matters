...
const Transform = () => {
  return (
    <Wrapper>
      <div className="transform py-16 text-center text-white max-w-[1248px] mx-auto md:px-20 px-5 flex flex-col gap-5 relative md:my-32 my-10">
        <Image
          src={group}
          alt="group"
          className="absolute right-0 top-0 w-[248px]"
        />
        <p className="font-spectral tracking-wider text-[24px] font-bold">
          Don’t Wait
        </p>
        <h2 className="text-center max-md:text-[26px] diffTheCapnotrainer !text-white">
          Transform Your Breathing Today!
        </h2>
        <p className="text-[16px] font-[400] leading-normal font-nunito mb-5">
        ...
        <span>
          <button
            className="p-5 bg-white text-[#008080] text-base rounded-lg font-extrabold font-nunito"
            style={{
              position: "relative",
              zIndex: 1,
            }}
